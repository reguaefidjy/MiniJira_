...
export const TICKETS: Ticket[] = [
  ...
  },
  {
    ...
    description:
      'Endpoint `GET /api/metrics/export` con streaming fila a fila (`res.write`). Soportar filtros: rango de fechas, estado y asignado. Cumplir RFC 4180.',
    status: 'done',
    priority: 'medium',
    is_blocked: false,
    version: 5,
...
// Mutable copies for in-memory CRUD during the session
export const db = {
  tickets: [...TICKETS],
  comments: [...COMMENTS],
  users: [...USERS],
